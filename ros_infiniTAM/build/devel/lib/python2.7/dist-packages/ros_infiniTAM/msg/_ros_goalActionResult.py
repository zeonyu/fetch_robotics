...
"""autogenerated by genpy from ros_infiniTAM/ros_goalActionResult.msg. Do not edit."""
import sys
...
class ros_goalActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "ros_infiniTAM/ros_goalActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','ros_infiniTAM/ros_goalResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ros_goalActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = ros_infiniTAM.msg.ros_goalResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = ros_infiniTAM.msg.ros_goalResult()
