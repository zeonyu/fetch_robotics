...
"""autogenerated by genpy from ros_infiniTAM/ros_goalAction.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import ros_infiniTAM.msg
import genpy
import actionlib_msgs.msg
import std_msgs.msg

class ros_goalAction(genpy.Message):
  _md5sum = "43be4cc5f00dbf6ac5fa03a36619be67"
  _type = "ros_infiniTAM/ros_goalAction"
...
"""
  ...
  _slot_types = ['ros_infiniTAM/ros_goalActionGoal','ros_infiniTAM/ros_goalActionResult','ros_infiniTAM/ros_goalActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ros_goalAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = ros_infiniTAM.msg.ros_goalActionGoal()
      if self.action_result is None:
        self.action_result = ros_infiniTAM.msg.ros_goalActionResult()
      if self.action_feedback is None:
        self.action_feedback = ros_infiniTAM.msg.ros_goalActionFeedback()
    else:
      self.action_goal = ros_infiniTAM.msg.ros_goalActionGoal()
      self.action_result = ros_infiniTAM.msg.ros_goalActionResult()
      self.action_feedback = ros_infiniTAM.msg.ros_goalActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_f.pack(self.action_feedback.feedback.completeness))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.action_feedback.feedback.completeness,) = _struct_f.unpack(str[start:end])
      return self
